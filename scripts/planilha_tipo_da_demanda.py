...
texto = [
    ...
    ["   AVISO PROTEÇÃO & SELETIVIDADE    1    proteção com outro nome"],
    ["                                   25"],
    [""],
    ["Eles continuam na aba 'Base dos 143', marcados como 'Fora da conta', para"],
    ["conferência. Passaram pelo posto 143; a conta de manutenção é sobre 118."],
    [""],
    ["Ressalva no AVISO PROTEÇÃO & SELETIVIDADE (7900001227, Recursolândia)"],
    [""],
    ["O tipo da SS diz proteção, mas o parecer mais recente da DMSL na ETO-COEP"],
    ["00100/2025 diz outra coisa: sensor interno de corrente com defeito, Cooper Form6"],
    ["de 2009, equipamento obsoleto, com pedido de substituição ao DCMD. Pelo texto"],
    ["seria falha de equipamento; pelo tipo, não. Saiu da conta pelo tipo — volta a"],
    ["qualquer momento se o gestor preferir seguir o parecer."],
    [""],
    ["O que continua na conta, mas não é falha"],
    [""],
    ["SOLICITAÇÃO DE SERVIÇO (4), AVISO DE ANOMALIA (2) e ANOMALIA EM RELIGADOR (1)"],
    ["também não são falha de equipamento. Somam 7 e seguem na conta até o gestor"],
    ["dizer o contrário — basta mandar que saem junto."],
    [""],
